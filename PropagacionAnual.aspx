<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PropagacionAnual.aspx.cs" Inherits="AltaPagos.PropagacionAnual" EnableEventValidation="false"  %>
<%@ Register TagPrefix="PixelwareApi" Namespace="PixelwareApi.Web" Assembly="PixelwareApi.Web" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Propagación anual de expedientes</title>
...
<body>
    ...
    <div>
        <div id="cabecera">
            Propagación anual de expedientes
        </div>
        <asp:MultiView ID="mainMultiView" runat="server">
            <asp:View ID="viewConfirm" runat="server">
                ...
                <div runat="server" id="IncidenciasDiv">
                    <p runat="server" id="LblExpedientesProblemas" class="marginTextProgagacion">Listado de expedientes con problemas:</p>
                ...
                <div class="ConfirmPropagacionDiv">
                    <asp:Label CssClass="marginTextOperacionPropagar" ID="labelConfirm" runat="server" Text="Se va a proceder a propagar los expedientes con caracter anual. Por favor, seleccione la fecha y el motivo de la propagación antes de continuar."></asp:Label>
