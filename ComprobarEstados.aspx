<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComprobarEstados.aspx.cs" Inherits="AltaPagos.ComprobarEstados" %>
...
<head id="Head" runat="server">
    ...
    <title>Comprobación del estado de ficheros cargados a SICER</title>
    ...
    <script type="text/javascript">
        ...
        function showWindow(URL) {
            noweOkno = window.open(URL, '_blank', 'menubar=no, toolbar=no, location=no, scrollbars=yes, resizable=no,' +
            'status=no, width=800, height=400, left=30, top=100')
            noweOkno.focus();
        }
            ...
            $("#divConfirmacion").dialog({
                buttons: {
                    "Generar": function () {
                        ...
                        $("#descargarEtiquetas").attr('href', 'ImprimirCodigosSicer.aspx?modo=0&codigoRemesa=' + value + '&filaComienzo=' + $("#filaImpresion option:selected").val());
...
<body>
    ...
    <div>
        <div id="cabecera">
            Comprobación del estado de ficheros e impresión de etiquetas
        </div>
        <br />
        <asp:MultiView ID="multiView" runat="server">
            <asp:View ID="viewFichero" runat="server">
                <div>
                    <asp:Label ID="labelConfirm" CssClass="subtitle" runat="server" Text="A continuación se muestra el estado de las remesas. Pulse en el estado para obtener información adicional."></asp:Label>
                </div>
                <br />
                ...
                <ExtendedProperties AddServerIds="true">
                    ...
                    <AlwaysShowHeader Enable="false" ShowEmptyRow="true" EmptyMessage="&lt;ML&gt;No se ha definido ninguna remesa.&lt;/ML&gt;" />
                </ExtendedProperties>
                    <Columns>
                        <asp:BoundField DataField="CODREMESA" HeaderText="Código Remesa">
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Estado Remesa">
                            <ItemTemplate>
                                <asp:HyperLink ID="link" runat="server" CssClass="CeldaNormal" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Acción" ItemStyle-HorizontalAlign="Center" >
                            <ItemTemplate>
                                <asp:Label ID="documentoLbl" runat="server"></asp:Label>
                                <asp:LinkButton ID="lbReenvioRemesa" runat="server" Text="Reenviar Remesa" CssClass="BotonActivo" OnClick="linkButtonReenviarRemesa_Click" Visible="false"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
            ...
            <asp:View ID="viewWait" runat="server">
                ...
                <asp:LinkButton ID="linkRemesa" runat="server" Text="" style="display:none" onclick="linkRemesa_Click" ></asp:LinkButton>
            </asp:View>
            <asp:View ID="viewSuccess" runat="server">
                <div class="title success">Se ha realizado la operación correctamente.</div>
            </asp:View>
            <asp:View ID="viewError" runat="server">
                <div class="title error">Ha ocurrido un error durante la operación.</div>
                <div class="subtitle"><asp:Literal ID="literalError" runat="server"></asp:Literal></div>
            </asp:View>
        </asp:MultiView>
        <div id="divConfirmacion" runat="server" title="Confirmación de generación de etiquetas" style="display:none">   
            <p>A continuación se procedera a generar las etiquetas de las comunicaciones asociadas a esta remesa.</p>
            <p>Seleccione en que fila de la hoja de etiquetas desea comenzar a imprimir:</p>  
