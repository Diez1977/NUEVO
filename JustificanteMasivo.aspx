<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JustificanteMasivo.aspx.cs" Inherits="AltaPagos.JustificanteMasivo" EnableEventValidation="false"  %>
<%@ Register TagPrefix="PixelwareApi" Namespace="PixelwareApi.Web" Assembly="PixelwareApi.Web" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Modelo 069 masivo</title>
...
<body>
    ...
    <div>
        <div id="cabecera">
            Generación masiva de modelo 069
        </div>
        <asp:MultiView ID="mainMultiView" runat="server">
            <asp:View ID="viewConfirm" runat="server">
                <div class="subtitle info"><asp:Label ID="labelConfirm" runat="server" Text="Se va a proceder a generar de forma masiva el modelo 069 de las {0} comunicaciones siguientes. ¿Desea continuar con la operación?"></asp:Label></div>
            ...
            <asp:View ID="viewWait" runat="server">
                <div class="title progress">Generación masiva de modelo 069 en progreso. Por favor, espere...</div>
                <asp:LinkButton ID="linkGenerar" runat="server" Text="" style="display:none"
                        onclick="linkGenerar_Click" ></asp:LinkButton>
            </asp:View>
            <asp:View ID="viewSuccess" runat="server">
                <div class="title success">Se han generado todos los modelo 069 correctamente.</div>
                ...
                <asp:Panel ID="panelWarnings" runat="server" Visible="false">
                    <div id="subtitleLabel" runat="server" class="subtitle">Durante la generación del modelo 069 se encontraron las siguientes incidencias:</div>
            ...
            <asp:View ID="viewError" runat="server">
                <div class="title error">No se han podido generar los modelos 069.</div>
