<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportesMasivo.aspx.cs" Inherits="AltaPagos.ImportesMasivo" EnableEventValidation="false"  %>
<%@ Register TagPrefix="PixelwareApi" Namespace="PixelwareApi.Web" Assembly="PixelwareApi.Web" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Liquidaciones masivas</title>
    ...
    <div>
        ...
        <asp:MultiView ID="mainMultiView" runat="server">
            <asp:View ID="viewConfirm" runat="server">
                <div class="subtitle info"><asp:Label ID="labelConfirm" runat="server" Text="Se va a proceder a generar de forma masiva la liquidación de las {0} comunicaciones siguientes. ¿Desea continuar con la operación?"></asp:Label></div>
                ...
                <div>
                    <PixelwareApi:ExtendedGridView ID="gridViewComunicaciones" runat="server" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="FECHAALTA" HeaderText="Fecha alta exp">
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="NOMBREINTER" HeaderText="Nombre y apellidos">
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="MUNICINTER" HeaderText="Municipio">
                            </asp:BoundField>
                        </Columns>
            ...
            <asp:View ID="viewWait" runat="server">
                <div class="title progress">Generación masiva de liquidaciones en progreso. Por favor, espere...</div>
                <asp:LinkButton ID="linkGenerar" runat="server" Text="" style="display:none"
                        onclick="linkGenerar_Click" ></asp:LinkButton>
            </asp:View>
            <asp:View ID="viewSuccess" runat="server">
                <div class="title success">Se han generado todas las liquidaciones correctamente.</div>
                ...
                <asp:Panel ID="panelWarnings" runat="server" Visible="false">
                    <div runat="server" id="subtitleText" class="subtitle">Durante la generación de las liquidaciones se encontraron las siguientes incidencias:</div>
            ...
            <asp:View ID="viewError" runat="server">
                <div class="title error">No se han podido generar las liquidaciones.</div>
