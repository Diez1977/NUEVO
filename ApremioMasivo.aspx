<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApremioMasivo.aspx.cs" Inherits="AltaPagos.ApremioMasivo" EnableEventValidation="false"  %>
<%@ Register TagPrefix="PixelwareApi" Namespace="PixelwareApi.Web" Assembly="PixelwareApi.Web" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Apremio masivo</title>
...
<body>
    ...
    <div>
        <div id="cabecera">
            Generación masiva de apremios
        </div>
        <asp:MultiView ID="mainMultiView" runat="server">
            <asp:View ID="viewConfirm" runat="server">
                <div class="subtitle info"><asp:Label ID="labelConfirm" runat="server" Text="Se va a proceder a generar masivamente los {0} 069 con apremio correspondientes a las siguientes comunicaciones. ¿Desea continuar con la operación?"></asp:Label></div>
            ...
            <asp:View ID="viewWait" runat="server">
                <div class="title progress">Generación masiva de apremios en progreso. Por favor, espere...</div>
                <asp:LinkButton ID="linkGenerar" runat="server" Text="" style="display:none"
                        onclick="linkGenerar_Click" ></asp:LinkButton>
            </asp:View>
            <asp:View ID="viewSuccess" runat="server">
                <div class="title success">Se han generado todos los apremios correctamente.</div>
                ...
                <asp:Panel ID="panelWarnings" runat="server" Visible="false">
                    <div class="subtitle" id="lblIncidencias" runat="server">Durante la generación de los apremios se encontraron las siguientes incidencias:</div>
            ...
            <asp:View ID="viewError" runat="server">
                <div class="title error">No se han podido generar los apremios.</div>
